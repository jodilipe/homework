//
//  SubjectHomeworkTableViewController.m
//  Homework
//
...
@implementation SubjectHomeworkTableViewController
...
- (void)viewWillAppear:(BOOL)animated {
	...
	for (Homework *currHomework in subject.homeworks) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (homework.note) {
        cell.textLabel.text = [NSString stringWithFormat:@"%@ %@ - %@", homework.subject.name, homework.assignment.name, homework.note];
    } else {
        cell.textLabel.text = [NSString stringWithFormat:@"%@ %@", homework.subject.name, homework.assignment.name];
    }
